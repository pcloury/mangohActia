...
// Startup code for the executable 'smsReceiver'.
...
LE_SHARED const char* _smsClient_le_sms_ServiceInstanceName = "smsReceiver.smsClient.le_sms";
LE_SHARED const char* _smsClient_le_dcs_ServiceInstanceName = "smsReceiver.smsClient.le_dcs";
LE_SHARED const char* _smsClient_le_net_ServiceInstanceName = "smsReceiver.smsClient.le_net";
LE_SHARED const char* _smsClient_le_gnss_ServiceInstanceName = "smsReceiver.smsClient.le_gnss";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t smsReceiver_exe_LogSession;
LE_SHARED le_log_Level_t* smsReceiver_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    smsReceiver_exe_LogSession = le_log_RegComponent("smsReceiver_exe", &smsReceiver_exe_LogLevelFilterPtr);
