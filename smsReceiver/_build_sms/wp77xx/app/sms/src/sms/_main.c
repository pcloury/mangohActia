...
// Startup code for the executable 'sms'.
...
LE_SHARED const char* _smsClient_le_sms_ServiceInstanceName = "sms.smsClient.le_sms";
LE_SHARED const char* _smsClient_le_dcs_ServiceInstanceName = "sms.smsClient.le_dcs";
LE_SHARED const char* _smsClient_le_net_ServiceInstanceName = "sms.smsClient.le_net";
LE_SHARED const char* _smsClient_le_gnss_ServiceInstanceName = "sms.smsClient.le_gnss";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t sms_exe_LogSession;
LE_SHARED le_log_Level_t* sms_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    sms_exe_LogSession = le_log_RegComponent("sms_exe", &sms_exe_LogLevelFilterPtr);
