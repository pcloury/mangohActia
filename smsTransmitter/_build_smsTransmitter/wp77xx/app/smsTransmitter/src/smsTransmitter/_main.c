...
// Startup code for the executable 'smsTransmitter'.
...
LE_SHARED const char* _smsClient_le_sms_ServiceInstanceName = "smsTransmitter.smsClient.le_sms";
LE_SHARED const char* _smsClient_le_dcs_ServiceInstanceName = "smsTransmitter.smsClient.le_dcs";
LE_SHARED const char* _smsClient_le_net_ServiceInstanceName = "smsTransmitter.smsClient.le_net";
LE_SHARED const char* _smsClient_le_gnss_ServiceInstanceName = "smsTransmitter.smsClient.le_gnss";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t smsTransmitter_exe_LogSession;
LE_SHARED le_log_Level_t* smsTransmitter_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    smsTransmitter_exe_LogSession = le_log_RegComponent("smsTransmitter_exe", &smsTransmitter_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_smsClient.so");
